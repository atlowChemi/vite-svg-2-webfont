...
export default defineConfig({
    ...
    head: [
        ...
        ['meta', { property: 'og:description', content: 'A Vite plugin that generates webfonts from SVG icons.' }],
        ['meta', { property: 'og:url', content: docsUrl }],
        ['meta', { property: 'og:image', content: socialImage }],
        ['meta', { property: 'og:image:alt', content: 'vite-svg-2-webfont social preview' }],
        ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
        ['meta', { name: 'twitter:title', content: repoName }],
        ['meta', { name: 'twitter:description', content: 'A Vite plugin that generates webfonts from SVG icons.' }],
